/// <reference path="../../../../../../../../node_modules/@types/filesystem/index.d.ts" /> // workspaces version
...
) => void = global.webkitRequestFileSystem || global.requestFileSystem || null
...
function _requestQuota(
  ...
  if (typeof (<any>navigator)['webkitPersistentStorage'] !== 'undefined') {
    ...
    ;(<any>global).webkitStorageInfo.requestQuota(
      type,
      size,
      success,
      errorCallback,
